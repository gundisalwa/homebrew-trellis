...
Homebrew tap for **[Trellis](https://gundisalwa.github.io/trellis/)** — a governance
layer that supervises an agentic software-development process.

```sh
brew install gundisalwa/trellis/trellis
```
...
[Trellis repo](https://github.com/gundisalwa/trellis).
